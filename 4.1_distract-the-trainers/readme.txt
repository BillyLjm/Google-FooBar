...
New challenge "Distract the Trainers" added to your home folder.
Time to solve: 360 hours.

>> foobar:~/ Billy.LJM$ cd distract-the-trainers

--------------------

>> foobar:~/distract-the-trainers Billy.LJM$ cat readme.txt
...
>> foobar:~/distract-the-trainers Billy.LJM$ edit solution.py

>> foobar:~/distract-the-trainers Billy.LJM$ verify solution.py

Verifying solution...

All test cases passed. Use submit solution.py to submit your solution

>> foobar:~/distract-the-trainers Billy.LJM$ submit solution.py
...
Submission: SUCCESSFUL. Completed in: 18 hrs, 15 mins, 52 secs.
