...
New challenge "Hey, I Already Did That!" added to your home folder.
Time to solve: 168 hours.

>> foobar:~/ Billy.LJM$ cd hey-i-already-did-that

--------------------

>> foobar:~/hey-i-already-did-that Billy.LJM$ cat readme.txt
...
>> foobar:~/hey-i-already-did-that Billy.LJM$ edit solution.py

>> foobar:~/hey-i-already-did-that Billy.LJM$ verify solution.py

Verifying solution...

All test cases passed. Use submit solution.py to submit your solution

>> foobar:~/hey-i-already-did-that Billy.LJM$ submit solution.py
...
Submission: SUCCESSFUL. Completed in: 40 mins, 22 secs.
