...
>> foobar:~/ Billy.LJM$ cd fuel-injection-perfection

--------------------

>> foobar:~/fuel-injection-perfection Billy.LJM$ cat readme.txt
...
>> foobar:~/fuel-injection-perfection Billy.LJM$ edit solution.py

>> foobar:~/fuel-injection-perfection Billy.LJM$ verify solution.py

Verifying solution...

All test cases passed. Use submit solution.py to submit your solution

>> foobar:~/fuel-injection-perfection Billy.LJM$ submit solution.py
...
Submission: SUCCESSFUL. Completed in: 1 hr, 42 mins, 46 secs.
