...
>> foobar:~/ Billy.LJM$ cd doomsday-fuel

--------------------

>> foobar:~/doomsday-fuel Billy.LJM$ cat readme.txt
...
>> foobar:~/doomsday-fuel Billy.LJM$ edit solution.py

>> foobar:~/doomsday-fuel Billy.LJM$ verify solution.py

Verifying solution...

All test cases passed. Use submit solution.py to submit your solution

>> foobar:~/doomsday-fuel Billy.LJM$ submit solution.py
...
Submission: SUCCESSFUL. Completed in: 13 hrs, 41 mins, 31 secs.
...
[rest of script continued in "../recruitment.txt"]